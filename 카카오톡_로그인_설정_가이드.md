...
5. 플랫폼 설정:
   ...
   - Redirect URI: `https://cdcdcd.kr/work-schedule/signup` (가입 페이지)
   - Redirect URI: `https://cdcdcd.kr/work-schedule` (로그인 페이지)
6. 제품 설정 → 카카오 로그인 활성화
7. Redirect URI 등록:
   - `https://cdcdcd.kr/work-schedule/signup`
   - `https://cdcdcd.kr/work-schedule`
   - `http://localhost:3000/work-schedule/signup` (개발용)
   - `http://localhost:3000/work-schedule` (개발용)
